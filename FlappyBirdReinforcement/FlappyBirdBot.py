...
def train(model, start):
    ...
    epsilon_dec = np.linspace(model.initial_epsilon, model.final_epsilon, model.number_of_iterations)
    ...
    while iteration<model.number_of_iterations:
        ...
        reward = torch.from_numpy(np.array([reward], dtype=p.float32)).unsqueeze(0)
